import math
import requests
from globalVariables import base_url, getRunningTrainings,universityUsername,password
from loginTest import get_header
url = base_url + getRunningTrainings

def getRunningTrainings(pageNum,pageSize,expected_status_code):
...
#get Running Trainings
getRunningTrainings(0,6,200)
#get Running Trainings -ve numbers
getRunningTrainings(-1,-10,400)
#get Running Trainings with big numbers
getRunningTrainings(100,100,200)
#get Running Trainings with null values
getRunningTrainings(math.nan,math.nan,400)
#unauthorized access 
unauthorizedAccess()
