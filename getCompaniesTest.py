import requests
from globalVariables import base_url, getCompanyAPI,universityUsername,password
from loginTest import get_header
url = base_url + getCompanyAPI
def getCompanies(pageNum,pageSize,expected_status_code):
...
#get companies
getCompanies(0,6,200)
#get compamies with -ve numbers
getCompanies(-1,-10,400)
#get companies with big numbers
getCompanies(100,100,200)
#unautherized access 
unauthorizedAccess()
